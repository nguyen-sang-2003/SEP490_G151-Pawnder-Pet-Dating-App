  ...
  const handleContinue = async () => {
    ...
    try {
      ...
      showAlert({
        type: 'success',
        title: 'Thành công!',
        message: `Đã tạo hồ sơ ${petName}. Hãy thêm một số hình ảnh!`,
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.form}>
          ...
          <View style={styles.inputGroup}>
            ...
            <View style={styles.inputContainer}>
              <TextInput
                placeholder="VD: Ba Tư, Anh Lông Ngắn"
                style={styles.input}
                placeholderTextColor={colors.textLabel}
                value={breed}
          ...
          <View style={styles.inputGroup}>
            ...
            <View style={styles.charCount}>
              <Text style={styles.helperText}>Tùy chọn • {description.length}/200</Text>
            </View>
          </View>
